...
songsList.push({
        ...
        genre: "edm",
        lyrics: {
          verse: "Party till the daylight x2\
    ...
    db.Song.remove({}, function(err, songs) {
      songsList.forEach(function (songData) {
        ...
        db.Lyric.findOne({name : songData.name}, function (err, foundLyric) {
          // console.log('found lyric by ', songData.name);
          console.log('foundLyric is ', foundLyric._id);
          // song.lyrics = foundLyric.lyrics.verse;
          // song.save(function(err, savedSong) {
          //   console.log('saved ' + savedSong.name + ' by ' + savedSong.aristName);
          // });
        });
      });
    });
